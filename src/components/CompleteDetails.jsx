...
const CompleteDetails = () => {
  ...
  return (
    <>
      ...
      <div className="successimage" style={{ width: "100%", height: "30%" }}>
  <img
    src={success}
  ...
  />
      ...
      <div className="container">
        <div className="section-title">
          <h2 style={{ fontFamily: "cursive", marginBottom: "0px" ,marginTop:"20ypx"}}>
            {filter} Schools
          </h2>
        </div>
        ...
        {showZoneSelector && (
          ...
          <div className="zone-selector">
            {zones.map((zone) => (
              <button
                key={zone}
                className={`zone-btn ${filter === zone ? 'active-zone-btn' : ''}`}
            ...
            <button
              className={`zone-btn ${filter === 'All Zones' ? 'active-zone-btn' : ''}`}
